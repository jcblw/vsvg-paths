...
test( 'testing decode::_createPoint', function( t ) {
    ...
    t.equals( Object.keys( decode._createPoint( m ) ).length, 2, '_createPoint will return an object that has the right amount of keys for a "m" point' )
    t.equals( Object.keys( decode._createPoint( l ) ).length, 2, '_createPoint will return an object that has the right amount of keys for a "l" point' )
    t.equals( Object.keys( decode._createPoint( v ) ).length, 1, '_createPoint will return an object that has the right amount of keys for a "v" point' )
    t.equals( Object.keys( decode._createPoint( h ) ).length, 1, '_createPoint will return an object that has the right amount of keys for a "h" point' )
    t.equals( Object.keys( decode._createPoint( s ) ).length, 4, '_createPoint will return an object that has the right amount of keys for a "s" point' )
    t.equals( Object.keys( decode._createPoint( q ) ).length, 4, '_createPoint will return an object that has the right amount of keys for a "q" point' )
    t.equals( Object.keys( decode._createPoint( a ) ).length, 7, '_createPoint will return an object that has the right amount of keys for a "a" point' )
    t.equals( Object.keys( decode._createPoint( c ) ).length, 6, '_createPoint will return an object that has the right amount of keys for a "c" point' )
    t.equals( Object.keys( decode._createPoint( m2 ) ).length, 2, '_createPoint will return an object that has the right amount of keys for a point and will ignore extra items in array' )
